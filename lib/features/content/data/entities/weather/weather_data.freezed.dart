...
/// @nodoc
mixin _$WeatherData {
  List<WeatherDataFromList> get list => throw _privateConstructorUsedError;
...
abstract class $WeatherDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<WeatherDataFromList> list, City city});
...
class _$_WeatherData implements _WeatherData {
  const _$_WeatherData(
      {required final List<WeatherDataFromList> list, required this.city})
      : _list = list;

  factory _$_WeatherData.fromJson(Map<String, dynamic> json) =>
      _$$_WeatherDataFromJson(json);

  final List<WeatherDataFromList> _list;
  @override
  List<WeatherDataFromList> get list {
...
abstract class _WeatherData implements WeatherData {
  const factory _WeatherData(
      {required final List<WeatherDataFromList> list,
      required final City city}) = _$_WeatherData;
